...
import { WebSocketService } from '../classes/WebSocketService.js'
...
export default function AppWithNavbarAndConnection() {
  ...
  useEffect(() => {
    ...
    setStompService(
      new WebSocketService(appContextValue, handleMessageFromWS, websocketUrl)
    )
  }, [username])
